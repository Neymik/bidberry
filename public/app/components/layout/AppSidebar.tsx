...
const navItems = [
  ...
  { path: '/penalties', label: 'Штрафы', icon: 'M12 9v2m0 4h.01M5 19h14a2 2 0 001.84-2.75L13.74 4a2 2 0 00-3.5 0L3.5 16.25A2 2 0 005.34 19z' },
  { path: '/emulator', label: 'Эмулятор', icon: 'M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z' },
];
